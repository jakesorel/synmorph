...
"""
Modification to the repressilator model whereby a high value of the first variable induces an increase in v0. 

Specifically v0_i = mu_move * x1_i
"""


class Repressilator_move:
    ...
    def update_grn(self, dt, dt_grn):
        ...
        self.t.active.active_params["v0"] = self.params["mu_move"] * self.var[:, 0]
