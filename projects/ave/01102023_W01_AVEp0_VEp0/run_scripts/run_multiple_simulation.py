...
if __name__ == "__main__":
    try:
        ...
        base_name = "01102023_W01_AVEp0_VEp0"
        ...
        def run_job(i,equiangulate=True):
            t_0 = time.time()
            if not os.path.exists("../scan_results/01102023_W01_AVEp0_VEp0_%d_simulation.h5.gz"%i):
                ...
                t1 = time.time()
                print(t1 - t0)
                out_file = open("../scan_summary/01102023_W01_AVEp0_VEp0_result_log.txt", "a")
            ...
            run_analysis("01102023_W01_AVEp0_VEp0_%d" % i)
